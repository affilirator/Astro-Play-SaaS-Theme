...
const sections = [
  {
    ...
    bgColor: "bg-primary",
    textColor: "text-light", // Light text on primary background
    highlightColor: "text-accent",
    hoverBgColor: "bg-accent", // Change to accent color on hover
  ...
  },
  {
    ...
    textColor: "text-light", // Light text on secondary background
    highlightColor: "text-accent",
    hoverBgColor: "bg-primary", // Change to primary color on hover
  ...
  },
  {
    ...
    bgColor: "bg-light", // Light background
    textColor: "text-dark", // Dark text on light background
    highlightColor: "text-primary",
    hoverBgColor: "bg-secondary", // Change to secondary color on hover
  ...
  },
  {
    ...
    bgColor: "bg-accent", // Accent background
    textColor: "text-dark", // Dark text on accent background
...
const IconBox = ({
  ...
  return (
    <motion.div
      ...
      variants={variants}
      className={`flex flex-col items-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 ease-in-out ${bgColor} ${textColor} text-center hover:scale-105 hover:shadow-2xl hover:rotate-x-6 hover:bg-opacity-90`}
      style={{ transition: "transform 0.6s ease, background-color 0.3s ease" }}
      whileHover={{ rotateX: 6, scale: 1.05 }}
    >
