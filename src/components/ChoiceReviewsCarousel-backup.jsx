...
const ReviewCarousel = () => {
  ...
  return (
    <section
      ref={ref}
      className="bg-gradient-to-b from-[#A27055] via-white to-[#106f26] py-16 text-center"
    >
      {/* Introduction */}
      <motion.div
      ...
      <div className="flex justify-center items-center">
        <motion.div
          ...
          className="relative bg-white shadow-lg rounded-lg p-6 max-w-lg mx-4 min-h-[220px] sm:min-h-[250px] md:min-h-[300px] flex flex-col justify-center"
        >
          {/* Speech Icon */}
          ...
          <div className="mt-4 text-right">
            <p className="text-[#A27055] font-semibold text-base sm:text-lg">
              {reviewsData[currentReview].name}
            </p>
            <p className="text-[#106f26] text-sm sm:text-base">
